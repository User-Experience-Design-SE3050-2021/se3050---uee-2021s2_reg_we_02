            ...
            <ScrollView>
                ...
                <View style={styles.secondRow}>
                    <View style={styles.smallCard}>
                        <Text style={styles.smallCardText} onPress={policies}>
                            Safe & reliable Payments
                        </Text>
                    </View>
                    <View style={styles.smallCard}>
                        <Text style={styles.smallCardText} onPress={contactus}>
                ...
                <View style={styles.FeaturedCategoryCard}>
                    <Text style={styles.TopRankingText}>Top Ranking</Text>
                    <ScrollView horizontal={true}
                        >
                        <View style={styles.FeaturedCategoryCardSubItm}>
                            <Image style={styles.FeaturedCategoryImg}  source={require("../../assets/images/watch.jpg")}/>
                        ...
                        <View onPress={ItemView} style={styles.FeaturedCategoryCardSubItm}>
                            <Image style={styles.FeaturedCategoryImg}  source={require("../../assets/images/bike.png")}/>
                            <Text style={styles.FeaturedCategoryCardSubItmText}>
                                Vehicles
                            </Text>
                        </View>
                        ...
                        <View style={styles.FeaturedCategoryCardSubItm}>
                            <Image style={styles.FeaturedCategoryImg}  source={require("../../assets/images/house1.jpg")}/>
                            <Text style={styles.FeaturedCategoryCardSubItmText}>
                                Properties
                            </Text>
                        </View>
                        <View style={styles.FeaturedCategoryCardSubItm}>
                            <Image style={styles.FeaturedCategoryImg}  source={require("../../assets/images/car1.jpg")}/>
                            <Text style={styles.FeaturedCategoryCardSubItmText}>
                                Cars
                            </Text>
                        </View>
                        <View style={styles.FeaturedCategoryCardSubItm}>
                            <Image style={styles.FeaturedCategoryImg}  source={require("../../assets/images/elec1.jpg")}/>
                            <Text style={styles.FeaturedCategoryCardSubItmText}>
                                Electronic Devices
                            </Text>
                        </View>
                        <View style={styles.FeaturedCategoryCardSubItm}>
                            <Image style={styles.FeaturedCategoryImg}  source={require("../../assets/images/cloth1.jpg")}/>
                            <Text style={styles.FeaturedCategoryCardSubItmText}>
                                Cloths
                            </Text>
                        </View>
                        <View style={styles.FeaturedCategoryCardSubItm}>
                            <Image style={styles.FeaturedCategoryImg}  source={require("../../assets/images/sport1.jpg")}/>
                            <Text style={styles.FeaturedCategoryCardSubItmText}>
                                Sports
                            </Text>
                        </View>
